<template>
  <div>
    ...
    <el-dialog  title="角色信息" :visible.sync="dialogFormVisible" width="400px" >
      <el-form label-width="80px" size="15px">
    ...
    <el-dialog style="font-size: 15px" size="15px" title="菜单分配" :visible.sync="menuDialogVis" width="400px">
      <el-tree
          :props="props"
          :data="menuData"
          show-checkbox
