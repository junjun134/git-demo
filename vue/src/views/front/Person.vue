<template>
  <el-card style="width: 500px;font-size: 15px;margin:0 25%">
    <el-form ref="from" :model="form" label-width="80px" size="15px" :rules="rules">
      <el-upload
      ...
      <el-form-item label="入职时间:">
        <div class="block" v-if="form.joinTime===null">
